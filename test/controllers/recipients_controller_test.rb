...
class RecipientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post recipients_url, params: { recipient: { account: @recipient.account, email: @recipient.email, list_id: @recipient.list_id } }
    end
  ...
  test "should update recipient" do
    patch recipient_url(@recipient), params: { recipient: { account: @recipient.account, email: @recipient.email, list_id: @recipient.list_id } }
